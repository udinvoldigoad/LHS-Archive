...
export const members = [
    {
        name: 'Ridho',
        role: 'Tukang Ide Dadakan',
        quote: 'Hidup cuma sekali, tapi revisi bisa berkali-kali.',
        funFact: 'Sering punya ide pas deadline sudah melihat dari kejauhan.',
    ...
    {
        name: 'Aryo',
        role: 'Divisi Rame-Rame',
        quote: 'Kalau bisa dibuat ribet, kenapa harus selesai cepat?',
        funFact: 'Datang membawa energi, pulang membawa cerita.',
    ...
    {
        name: 'Syehab',
        role: 'Penjaga Mood Tidak Resmi',
        quote: 'Diam bukan berarti tidak tahu, bisa jadi sedang loading.',
        funFact: 'Kadang terlihat santai, padahal pikirannya tabrakan.',
    ...
    {
        name: 'Nadia',
        role: 'Operator Ketawa',
        quote: 'Masalah boleh banyak, stok ngakak jangan habis.',
        funFact: 'Bisa mengubah obrolan random jadi agenda serius.',
    ...
    {
        name: 'Farel',
        role: 'Koordinator Hilang Sinyal',
        quote: 'Aku otw itu konsep, bukan lokasi.',
        funFact: 'Paling sering muncul pas semua orang sudah mulai pasrah.',
    ...
    {
        name: 'Dinda',
        role: 'Menteri Dokumentasi',
        quote: 'Kalau ga difoto, nanti sejarahnya denial.',
        funFact: 'Memiliki bukti visual untuk hampir semua kejadian.',
    ...
    {
        name: 'Raka',
        role: 'Ahli Debat Ringan',
        quote: 'Aku cuma nanya, kok jadi rapat?',
        funFact: 'Bisa membuka diskusi dari satu kalimat polos.',
    ...
    {
        name: 'Tasya',
        role: 'Kurator Drama Kecil',
        quote: 'Tenang, ini cuma fase sebelum chaos.',
        funFact: 'Selalu tahu mana cerita yang perlu disimpan.',
    ...
    {
        name: 'Bagas',
        role: 'Bendahara Cemilan',
        quote: 'Kita boleh miskom, asal jangan miskin snack.',
        funFact: 'Datang dengan plastik kresek yang isinya misterius.',
    ...
    {
        name: 'Mira',
        role: 'Penerjemah Situasi',
        quote: 'Maksudnya bukan begitu, tapi ya agak begitu.',
        funFact: 'Punya kemampuan merapikan obrolan yang hampir meledak.',
    ...
    {
        name: 'Jovan',
        role: 'Pilot Rencana B',
        quote: 'Plan A gagal? Bagus, plotnya mulai menarik.',
        funFact: 'Tenang di luar, tab browser mentalnya dua puluh.',
        instagramUrl: 'https://example.com/jovan',
        photoUrl: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=500&q=80',
    },
    {
        name: 'Lala',
        role: 'Arsiparis Perasaan',
        quote: 'Jangan lupa, ini nanti lucu kalau diingat.',
        funFact: 'Sering benar tentang momen yang awalnya terlihat biasa.',
